...
if "default" in mode:
    ...
    pb210_peak_centre_errs.append(np.sqrt(pb210_peak1_err[1, 1]))
    ...
    pb210_peak_centre_errs.append(np.sqrt(pb210_peak2_err[1, 1]))
    ...
    pb210_peak_centre_errs.append(np.sqrt(pb210_peak3_err[1, 1]))
    ...
    pb210_peak_centre_errs.append(np.sqrt(pb210_peak4_err[1, 1]))
    ...
    pb210_calib_fit, pb210_calib_err = calib.calib_curve(
        pb210_peak_centres,
        pb210_peak_centre_errs,
        [10.555, 12.305, 12.618, 15.222],  # trial 1, saved under /outputs/calib_radioactive/
...
if "high_rate" in mode:
    ...
    cs137_peak_centre_errs.append(np.sqrt(cs137_peak1_err[1, 1]))
    ...
    cs137_peak_centre_errs.append(np.sqrt(cs137_peak2_err[1, 1]))
