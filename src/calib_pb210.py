...
if __name__ == "__main__":
    ...
    peak_channels = np.array([pb210_peak1_centroid, pb210_peak2_centroid, pb210_peak3_centroid, pb210_peak4_centroid])
    ...
    plt.text(245, 385, "calibration curve: $E=" + str(round(calib_fit[0], 4)) + "N" + str(round(calib_fit[1], 3)) + "$", ha='center', va='center', transform=None)
